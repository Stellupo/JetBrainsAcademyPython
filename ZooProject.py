...
number = 0
while (number) <= 5 and (number)>=0 :
    print("What animal would you like to watch ? Type a number between 0 and 5 or exit to leave")
    number =input()
    if str(number) == 'exit':
        print ('See you!')
        break
    ...
    if number <0 or (number)>5 :
        print("PLEASE, WE SAID 'type a number between 0 and 5 or exit to leave'!!!!!")
        number=0
    else:
